...
{isSearching && <div className={styles.searching}>
  ...
  {loading && <div className={styles.searching}>
  <p >Buscando...</p></div>}

    {!loading && !isSearching && !visiblePokemons.length && <div className={styles.searching}>
  <p >Não há nenhum resultado para exibir.</p></div>}
  
  <div className={styles.pokemonContainer}>
    {!isSearching && !loading && visiblePokemons.map((pokemon) => {
